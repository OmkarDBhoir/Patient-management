...
public class PatientManagementDeployment extends Stack {

    private final Vpc vpc;
    private final Cluster ecsCluster;

    public PatientManagementDeployment(final App scope, final String id, final StackProps props) {
    ...
    private DatabaseInstance createDatabase(String id, String dbName) {
        return DatabaseInstance.Builder.create(this, id)
                .engine(DatabaseInstanceEngine.postgres(
                        PostgresInstanceEngineProps.builder().version(PostgresEngineVersion.VER_17_2)
                                .build()))
                .vpc(this.vpc)
                ...
                .databaseName(dbName)
                .removalPolicy(RemovalPolicy.DESTROY)  // Only for local development
                .build();
    }
